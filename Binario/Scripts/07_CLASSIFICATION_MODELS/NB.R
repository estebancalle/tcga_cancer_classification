...
prob_nb_boruta <- predict(modelo_nb_boruta,newdata = testdfBoruta, type = "prob")

# Matriz confusión
(conf_nb_boruta<- confusionMatrix(pred_nb_boruta, testdfBoruta$Labels, positive= "Tumor"))
...
saveRDS(prob_nb_boruta, here("Models/Predictions/prob_nb_boruta.rds"))
...
# Probabilidades Predicciones
prob_nb_pca <- predict(modelo_nb_pca,newdata = testdfPCA, type = "prob")

# Matriz confusión
(conf_nb_pca<- confusionMatrix(pred_nb_pca, testdfPCA$Labels, positive= "Tumor"))
...
saveRDS(prob_nb_pca, here("Models/Predictions/prob_nb_pca.rds"))
...
# Probabilidades Predicciones
prob_nb_lasso <- predict(modelo_nb_lasso,newdata = testdflasso, type = "prob")

# Matriz confusión
(conf_nb_lasso<- confusionMatrix(pred_nb_lasso, testdflasso$Labels, positive= "Tumor"))
...
saveRDS(prob_nb_lasso, here("Models/Predictions/prob_nb_lasso.rds"))
...
# Probabilidades Predicciones
prob_nb_SPLSDA <- predict(modelo_nb_SPLSDA,newdata = testdfSPLSDA, type = "prob")

# Matriz confusión
(conf_nb_SPLSDA<- confusionMatrix(pred_nb_SPLSDA, testdfSPLSDA$Labels, positive= "Tumor"))
...
saveRDS(prob_nb_SPLSDA, here("Models/Predictions/prob_nb_splsda.rds"))
