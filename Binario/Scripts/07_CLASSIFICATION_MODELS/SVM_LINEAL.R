...
prob_svml_boruta <- predict(modelo_svml_boruta,newdata = testdfBoruta, type = "prob")

# Matriz confusión
(conf_svml_boruta<- confusionMatrix(pred_svml_boruta, testdfBoruta$Labels, positive= "Tumor"))
...
saveRDS(prob_svml_boruta, here("Models/Predictions/prob_svml_boruta.rds"))
### SVML - PCA ---------------------------------------------------------------
...
# Probabilidades Predicciones
prob_svml_pca <- predict(modelo_svml_pca,newdata = testdfPCA, type = "prob")

# Matriz confusión
(conf_svml_pca<- confusionMatrix(pred_svml_pca, testdfPCA$Labels, positive= "Tumor"))
...
saveRDS(prob_svml_pca, here("Models/Predictions/prob_svml_pca.rds"))
### SVML - LASSO -------------------------------------------------------------
...
# Matriz confusión
(conf_svml_lasso<- confusionMatrix(pred_svml_lasso, testdflasso$Labels, positive= "Tumor"))

# Probabilidades Predicciones
prob_svml_lasso <- predict(modelo_svml_lasso,newdata = testdflasso, type = "prob")
...
saveRDS(prob_svml_lasso, here("Models/Predictions/prob_svml_lasso.rds"))
...
# Probabilidades Predicciones
prob_svml_SPLSDA <- predict(modelo_svml_SPLSDA,newdata = testdfSPLSDA, type = "prob")

# Matriz confusión
(conf_svml_SPLSDA<- confusionMatrix(pred_svml_SPLSDA, testdfSPLSDA$Labels, positive= "Tumor"))
...
saveRDS(prob_svml_SPLSDA, here("Models/Predictions/prob_svml_splsda.rds"))
