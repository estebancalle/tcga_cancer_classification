...
# Matriz confusión
(conf_svmr_boruta<- confusionMatrix(pred_svmr_boruta, testdfBoruta$Labels))
...
# Matriz confusión
(conf_svmr_pca<- confusionMatrix(pred_svmr_pca, testdfPCA$Labels))
...
# Matriz confusión
(conf_svmr_lasso<- confusionMatrix(pred_svmr_lasso, testdflasso$Labels))
...
# Matriz confusión
(conf_svmr_SPLSDA<- confusionMatrix(pred_svmr_SPLSDA, testdfSPLSDA$Labels))
