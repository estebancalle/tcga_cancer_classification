...
# Matriz confusión
(conf_rf_boruta<- confusionMatrix(pred_rf_boruta, testdfBoruta$Labels))
...
# Matriz confusión
(conf_rf_pca<- confusionMatrix(pred_rf_pca, testdfPCA$Labels))
...
# Matriz confusión
(conf_rf_lasso<- confusionMatrix(pred_rf_lasso, testdflasso$Labels))
...
# Matriz confusión
(conf_rf_SPLSDA<- confusionMatrix(pred_rf_SPLSDA, testdfSPLSDA$Labels))
