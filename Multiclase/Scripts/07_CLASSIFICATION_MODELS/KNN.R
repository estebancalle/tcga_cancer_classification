...
# Matriz confusión
(conf_knn_boruta<- confusionMatrix(pred_knn_boruta, testdfBoruta$Labels))
...
# Matriz confusión
(conf_knn_pca<- confusionMatrix(pred_knn_pca, testdfPCA$Labels))
...
# Matriz confusión
(conf_knn_lasso<- confusionMatrix(pred_knn_lasso, testdflasso$Labels))
...
# Matriz confusión
(conf_knn_SPLSDA<- confusionMatrix(pred_knn_SPLSDA, testdfSPLSDA$Labels))
