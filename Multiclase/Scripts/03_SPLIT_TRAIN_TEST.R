...
datos_preprocessed <- readRDS(here("Data/Merged_dataset/Preprocessed","df_unficado_sampled.rds"))
...
mean(datos_train_preprocessed$Labels == "BRCA")

# Guardamos la info del resultado
cat(capture.output(print(mean(datos_train_preprocessed$Labels == "BRCA"))), file = here("Info_outputs/","Accuracy basal.txt"))
